<div class="navbar bg-black text-white fixed top-0 left-0 p-0 z-50">
    <div class="flex-1">
        ...
        <ul class="menu menu-horizontal p-1">
            ...
            @else
                <li>
                    <details>
                        <summary>
                            <img class="size-12 rounded-full border-2" src="{{ asset('images/' . Auth::user()->photo) }}">
                            {{ Auth::user()->fullname }}
                        </summary>
                        <ul class="bg-black rounded-t-none flex flex-col gap-y-1 p-2 w-48 absolute top-12 right-0">
