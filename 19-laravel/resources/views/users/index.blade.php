...
@section('content')
    ...
    <div class="overflow-x-auto rounded-box border border-base-content/5 bg-black/50">
        <table class="table text-white">
            ...
            <tbody>
                @foreach ($users as $user)
                    <tr class="even:bg-black/60">
                        ...
                        <td>
                            @if ($user->role == 'Admin')
                                <span class="badge badge-otline badge-accent">Admin</span>
                            @else
                                <span class=" badge badge-otline badge-info">Customer</span>
                            @endif
                        </td>
            ...
            <tfoot>
                <tr>
                    <td colspan="7">{{ $users->links('partial.pagination') }}</td>
                </tr>
            </tfoot>
        </table>
    </div>
